...
from 'C:\Projects\DataWarehouses\DW_Populating\data\T2\CarRepairMaster\Mechanics.csv'
with
(
    firstrow = 2,
    datafiletype = 'char',
...
from 'C:\Projects\DataWarehouses\DW_Populating\data\T2\CarRepairMaster\Parts.csv'
with
(
    firstrow = 2,
    datafiletype = 'char',
...
from 'C:\Projects\DataWarehouses\DW_Populating\data\T2\CarRepairMaster\Repairs.csv'
with
(
    firstrow = 2,
    datafiletype = 'char',

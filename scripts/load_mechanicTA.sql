...
go
INSERT INTO TempFileNames EXEC master.dbo.xp_DirTree 'C:\Projects\DataWarehouses\DW_Populating\data\T1\CEOExcel\',1,1;
go
...
BEGIN
	...
	SET @SQL = 'bulk insert TempMechanicTAs
				from ''C:\Projects\DataWarehouses\DW_Populating\data\T1\CEOExcel\' + @FILENAME +'''
				with
				(
					firstrow = 2,
					datafiletype = ''char'',
